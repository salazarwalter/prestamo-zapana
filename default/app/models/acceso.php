...
//		   );
    ...
    public function lista_accesosXperfil($perfil_id) {
        $sql = "SELECT acceso.*, accion.accion,controlador.controlador 
                ...
                WHERE acceso.perfil_id = $perfil_id ";
//                  die($sql);
        $lista = $this->find_all_by_sql($sql);
//        if( count($lista)<1){
//            Flash::error("No hallado");
//            return FALSE;
//        }
        return $lista;
    }
